...
<script>
	export default {
		...
		async onShow() {
			...
			uni.removeStorageSync('dhzyszdw')
			...
			if(uni.getStorageSync('dhzywzjnr') !='' && uni.getStorageSync('dhzywzjnr') !=null){
				this.dataList.dhzywzjnr = uni.getStorageSync('dhzywzjnr')
			}
			uni.removeStorageSync('dhzywzjnr')
		...
		methods: {
			...
			getZb(){
				...
				uni.setStorageSync('dhzyszdw',this.dataList.dhzyszdw)
				...
				uni.setStorageSync('dhzywzjnr',this.dataList.dhzywzjnr)
