...
<script>
	export default {
		...
		async onShow() {
			...
			if(uni.getStorageSync('zywzjzynr') !='' && uni.getStorageSync('zywzjzynr') !=null){
				this.dataList.zywzjzynr = uni.getStorageSync('zywzjzynr')
			}
			uni.removeStorageSync('zywzjzynr')
			...
			if(uni.getStorageSync('lsqk') !='' && uni.getStorageSync('lsqk') !=null){
				this.dataList.lsqk = uni.getStorageSync('lsqk')
			}
			uni.removeStorageSync('lsqk')
		...
		methods: {
			...
			getZb(){
				...
				uni.setStorageSync('zywzjzynr',this.dataList.zywzjzynr)
				uni.setStorageSync('bz',this.dataList.bz)
				uni.setStorageSync('lsqk',this.dataList.lsqk)
				uni.navigateTo({
					url:'../zuobiao/shouxianMap'
				})
			},
			//添加受限空间
			async addSx(){
