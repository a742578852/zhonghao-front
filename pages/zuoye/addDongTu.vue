...
<script>
	...
	export default {
		...
		async onShow() {
			...
			if(uni.getStorageSync('dtzyszdw') !='' && uni.getStorageSync('dtzyszdw') !=null){
				this.dataList.dtzyszdw = uni.getStorageSync('dtzyszdw')
			}
			uni.removeStorageSync('dtzyszdw')
			...
			if(uni.getStorageSync('dtzywzjnr') !='' && uni.getStorageSync('dtzywzjnr') !=null){
				this.dataList.dtzywzjnr = uni.getStorageSync('dtzywzjnr')
			}
			uni.removeStorageSync('dtzywzjnr')
		...
		methods: {
			...
			getZb(){
				...
				uni.setStorageSync('dtzyszdw',this.dataList.dtzyszdw)
				...
				uni.setStorageSync('dtzywzjnr',this.dataList.dtzywzjnr)
				uni.setStorageSync('bz',this.dataList.bz)
				uni.navigateTo({
					url:'../zuobiao/dongtuMap'
				})
			},
			//添加动土
			async addDt(){
				...
				this.mapList.todaytip += this.dataList.dtzywzjnr
				//添加坐标
			...
			// },
			confirm(e){
				this.dataList.dtzyszdw = e[e.length-1].label
