<template>
	<view>
		...
		<view class="cu-form-group align-start">
			...
			<textarea maxlength="-1"  v-model='dataList.dlzywzjnr'></textarea>
		</view>
		<view class="cu-form-group align-start">
		...
		<button type="primary" style="width: 50%;margin-top: 20rpx;margin-bottom: 20rpx;" @click="addDl">确定</button>
...
<script>
	export default {
		...
		async onShow() {
			...
			if(uni.getStorageSync('dlzyszdw') !='' && uni.getStorageSync('dlzyszdw') !=null){
				this.dataList.dlzyszdw = uni.getStorageSync('dlzyszdw')
			}
			uni.removeStorageSync('dlzyszdw')
			...
			if(uni.getStorageSync('dlzywzjnr') !='' && uni.getStorageSync('dlzywzjnr') !=null){
				this.dataList.dlzywzjnr = uni.getStorageSync('dlzywzjnr')
			}
			uni.removeStorageSync('dlzywzjnr')
		...
		methods: {
			...
			getZb(){
				...
				uni.setStorageSync('dlzyszdw',this.dataList.dlzyszdw)
				...
				uni.setStorageSync('dlzywzjnr',this.dataList.dlzywzjnr)
				uni.setStorageSync('bz',this.dataList.bz)
				uni.navigateTo({
					url:'../zuobiao/duanluMap'
				})
			},
			//添加断路
			async addDl(){
