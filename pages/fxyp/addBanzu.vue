	...
	<view>
		...
		<scroll-view class="scroll-view_H" scroll-x="true" >
				...
				<view class="content-itemm" >
					<view class="cu-form-group" style="width: 190rpx;">
						<picker @change="bindPickerChange" :value="index" :range="arrayYhqk" class="item2" >
							<view class="uni-input" style="">{{arrayYhqk[index]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						<picker @change="bindPickerChange1" :value="index1" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index1]}}</view>
						</picker>
					</view>
				</view>
			</view>
			<view class="content">
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						<picker @change="bindPickerChange2" :value="index1" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index2]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						<picker @change="bindPickerChange3" :value="index3" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index3]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						...
						<picker @change="bindPickerChange4" :value="index4" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index4]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						...
						<picker @change="bindPickerChange5" :value="index5" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index5]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						...
						<picker @change="bindPickerChange6" :value="index6" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index6]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						<picker @change="bindPickerChange7" :value="index7" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index7]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						<picker @change="bindPickerChange8" :value="index8" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index8]}}</view>
						</picker>
					</view>
				</view>
			</view>
				...
				<view class="content-itemm">
					<view class="cu-form-group" style="width: 190rpx;">
						...
						<picker @change="bindPickerChange9" :value="index9" :range="arrayYhqk" class="item2" style="">
							<view class="uni-input" style="">{{arrayYhqk[index9]}}</view>
						</picker>
					</view>
				</view>
			</view>
		...
		<button type="primary" style="width: 50%;margin-top: 20rpx;margin-bottom: 20rpx;" @click="addBz">确定</button>
	</view>
</template>
